...
const fetchUser = async (username) => {
  const response = await fetch(`http://5707-82-124-194-242.ngrok.io/api/users/${searchUser}`);
...
export default function SearchScreen() {
  ...
  return (
    <View style={styles.screen}>
      ...
      />
      <TextInput style={styles.input} onChange={setsearchUser} placeholder="search an user.."></TextInput>
      <Button
